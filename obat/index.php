            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="col-2">
                        ...
                        <a href="proses-obat.php?id=<?= $obat ['id'] ?>&aksi=hapus-obat" onclick="return confirm('Anda yakin mau menghapus obat ini ?')" class="btn btn-sm btn-outline-danger" title="hapus obat"><i class="bi bi-trash align-top"></i></a>
                    </td>
                </tr>
                <?php } ?>
            </tbody>
