            ...
            <div class="col-lg-6 pe-4">
                ...
                <div class="form-group mb-3">
                 ...
                 <div class="form-group mb-3">
                    ...
                    <input type="text" id="namaPasien" class="form-control border-8 border-bottom mb-3" placeholder="nama pasien" value="<?= $rm['nama'] ?>"  readonly>
                    <textarea name="" id="alamatPasien" class="form-control border-8 bolder-bottom" placeholder="alamat pasien" rows="1" readonly ><?= $rm['alamatpasien'] ?></textarea>
                </div>
                <div class="form-group mb-3">
