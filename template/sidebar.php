      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 <?= $menu == 'index.php' ? 'active' : null ?>" aria-current="page" href="<?=
               $main_url ?>">
         ...
         <?php } ?>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2  <?= $menu == 'otentikasi' ? 'active' : null ?>" href="<?=
               $main_url ?>otentikasi/password.php">
          ...
          <?php if ($dataUser['jabatan'] != 3) { ?>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 <?= $menu == 'pasien' ? 'active' : null ?>" href="<?=
               $main_url ?>pasien">
            ...
            <?php } ?>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 <?= $menu == 'obat' ? 'active' : null ?>" href="<?=
               $main_url ?>obat">
